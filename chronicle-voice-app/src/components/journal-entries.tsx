...
export function JournalEntries({ entries, selectedEntryId, onEntrySelect }: JournalEntriesProps) {
          ...
          >
            <Card
              className={cn(
                ...
                selectedEntryId === entry.id ? "border-primary" : "border-border",
              )}
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {expandedId === entry.id ? entry.content : getContentPreview(entry.content)}
                </p>
